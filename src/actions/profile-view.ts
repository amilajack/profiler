 ...
 */
export function selectLeafCallNode(threadsKey: ThreadsKey, sampleIndex: IndexIntoSamplesTable): ThunkAction<void> {
 ...
 * of that sample's stack.
 */
export function selectRootCallNode(threadsKey: ThreadsKey, sampleIndex: IndexIntoSamplesTable): ThunkAction<void> {
  return (dispatch: Dispatch, getState: GetState) => {
    const threadSelectors = getThreadSelectorsFromThreadsKey(threadsKey);
    const filteredThread = threadSelectors.getFilteredThread(getState());
    const callNodeInfo = threadSelectors.getCallNodeInfo(getState());
 ...
 */
export function selectBestAncestorCallNodeAndExpandCallTree(threadsKey: ThreadsKey, sampleIndex: IndexIntoSamplesTable): ThunkAction<boolean> {
  return (dispatch: Dispatch, getState: GetState) => {
    const threadSelectors = getThreadSelectorsFromThreadsKey(threadsKey);
 ...
 * track.
 */
export function selectTrack(trackReference: TrackReference, modifier: 'none' | 'ctrl'): ThunkAction<void> {
  return (dispatch: Dispatch, getState: GetState) => {
 ...
 * track.
 */
export function selectActiveTabTrack(trackReference: ActiveTabTrackReference): ThunkAction<void> {
  return (dispatch: Dispatch, getState: GetState) => {
    const currentlySelectedTab = getSelectedTab(getState());
...
export function changeSelectedMarker(threadsKey: ThreadsKey, selectedMarker: MarkerIndex | null): Action {
  return {
...
export function changeSelectedNetworkMarker(threadsKey: ThreadsKey, selectedNetworkMarker: MarkerIndex | null): Action {
  return {
 ...
 */
export function changeHoveredMarker(threadsKey: ThreadsKey, hoveredNetworkMarker: MarkerIndex | null): Action {
  return {
 ...
 * used to display its context menu.
 */
export function changeRightClickedMarker(threadsKey: ThreadsKey, markerIndex: MarkerIndex | null): Action {
  return {
...
export function addTransformToStack(threadsKey: ThreadsKey, transform: Transform): ThunkAction<void> {
  return (dispatch: Dispatch, getState: GetState) => {
...
export function changeProfileName(profileName: string | null): ThunkAction<Promise<void>> {
...
export function changeMouseTimePosition(mouseTimePosition: Milliseconds | null): Action {
  return {
