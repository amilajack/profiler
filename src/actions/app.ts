...
export function reportTrackThreadHeight(threadsKey: ThreadsKey, height: CssPixels): ThunkAction<void> {
  return (dispatch: Dispatch, getState: GetState) => {
 ...
 */
export function setCurrentProfileUploadedInformation(uploadedProfileInformation: UploadedProfileInformation | null): Action {
  return {
...
export function updateBrowserConnectionStatus(browserConnectionStatus: BrowserConnectionStatus): Action {
