...
const _upgraders = {
  ...
  [4]: (profile) => {
    profile.threads.forEach((thread) => {
      ...
      function addLibResource(name: any, lib: any) {
  ...
  [9]: (profile) => {
    ...
    function convertPhaseTimes(old_phases: any) {
  ...
  [41]: (profile) => {
    ...
    for (const thread of profile.threads) {
      ...
      const getOrAddNewLib = (libIndex: any) => {
