...
import type {AddressResult, LibSymbolicationRequest, LibSymbolicationResponse} from './symbol-store';
...
export type QuerySymbolicationApiCallback = (path: string, requestJson: string) => Promise<MixedObject>;
