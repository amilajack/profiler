...
class JsTracerCanvasImpl extends React.PureComponent<Props, State> {
   ...
   * as follow-ups.
   */
  getHoveredItemInfo = (_hoveredItem: IndexIntoJsTracerEvents): React.ReactElement | null => {
    return null;
    // return (
...
export const JsTracerCanvas = (withChartViewport as WithChartViewport<OwnProps, Props>)(JsTracerCanvasImpl);
