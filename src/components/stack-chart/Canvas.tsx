...
class StackChartCanvasImpl extends React.PureComponent<Props> {
  ...
  _drawCanvas = (
    ...
    const pixelAtViewportPosition = (viewportPosition: UnitIntervalOfProfileRange): DevicePixels => devicePixelRatio *
  ...
  _getCallNodeIndexOrMarkerIndexFromHoveredItem(hoveredItem: HoveredStackTiming | null): {
    index: number,
    type: 'marker' | 'call-node'
  } | null {
    if (hoveredItem === null) {
      return null;
    }
...
export const StackChartCanvas = (withChartViewport as WithChartViewport<OwnProps, Props>)(StackChartCanvasImpl);
