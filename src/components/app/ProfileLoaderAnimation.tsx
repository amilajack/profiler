...
const LOADING_MESSAGES_L10N_ID: {
  [key: string]: string
} = Object.freeze({
...
type ProfileLoaderAnimationProps = ConnectedProps<Record<any, any>, ProfileLoaderAnimationStateProps, Record<any, any>>;
...
export const ProfileLoaderAnimation = explicitConnect<Record<any, any>, ProfileLoaderAnimationStateProps, Record<any, any>>({
