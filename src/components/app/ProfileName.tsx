...
class ProfileNameImpl extends React.PureComponent<Props, State> {
  ...
  changeProfileNameIfChanged = (event: React.SyntheticEvent<HTMLInputElement>) => {
...
export const ProfileName = explicitConnect<Record<any, any>, StateProps, DispatchProps>({
