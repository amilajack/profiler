...
type StateProps = {
  ...
  readonly sourceViewSource: FileSourceStatus | undefined,
...
type DispatchProps = {
  readonly beginLoadingSourceFromUrl: typeof beginLoadingSourceFromUrl,
  readonly beginLoadingSourceFromBrowserConnection: typeof beginLoadingSourceFromBrowserConnection,
  readonly finishLoadingSource: typeof finishLoadingSource,
  readonly failLoadingSource: typeof failLoadingSource
};
...
export const SourceFetcher = explicitConnect<Record<any, any>, StateProps, DispatchProps>({
