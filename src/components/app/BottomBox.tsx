...
type StateProps = {
  ...
  readonly sourceViewActivationGeneration: number,
...
type SourceStatusOverlayProps = {
  status: FileSourceStatus
};

function SourceStatusOverlay({
  status,
...
export const BottomBox = explicitConnect<Record<any, any>, StateProps, DispatchProps>({
