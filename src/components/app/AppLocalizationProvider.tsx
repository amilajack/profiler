...
type ProviderProps = ConnectedProps<ProviderOwnProps, ProviderStateProps, ProviderDispatchProps>;
...
export const AppLocalizationProvider = explicitConnect<ProviderOwnProps, ProviderStateProps, ProviderDispatchProps>({
