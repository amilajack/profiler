...
function _renderRowOfList(labelL10nId: string, data: string[]): React.ReactElement | null {
  if (!data.length) {
    return null;
  }
  return (
...
export const MetaInfoPanel = explicitConnect<Record<any, any>, StateProps, DispatchProps>({
