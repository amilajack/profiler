...
type StateProps = {
  ...
  readonly abortFunction: () => unknown,
  readonly timelineTrackOrganizationType: 'full' | 'active-tab' | 'origins'
};
...
class MenuButtonsPublishImpl extends React.PureComponent<PublishProps> {
  _toggles: Partial<Record<keyof CheckedSharingOptions, () => unknown>> = {
...
class DownloadButton extends React.PureComponent<DownloadButtonProps, DownloadButtonState> {
  ...
  static getDerivedStateFromProps(props: DownloadButtonProps, state: DownloadButtonState): Partial<DownloadButtonState> | null {
