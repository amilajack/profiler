...
class ActionButtons extends React.PureComponent<ActionButtonsProps, ActionButtonsState> {
  ...
  _takeInputRef = (input: null | HTMLInputElement) => {
...
type HomeProps = ConnectedProps<OwnHomeProps, StateHomeProps, DispatchHomeProps>;

type HomeState = {
  popupInstallPhase: PopupInstallPhase
};

type PopupInstallPhase = // Firefox:
'checking-webchannel' | 'webchannel-unavailable' | 'popup-enabled' | // Other browsers:
'suggest-enable-popup' | 'other-browser';
...
export const Home = explicitConnect<OwnHomeProps, StateHomeProps, DispatchHomeProps>({
