...
type ButtonProps = {
  ...
  readonly onOpenConfirmDialog: () => unknown,
  readonly onCloseConfirmDialog: () => unknown,
  readonly onCloseSuccessMessage: () => unknown
};
...
type PanelProps = {
  ...
  /* This token is used to authenticate the deletion HTTP request to the server. */
  readonly jwtToken: string,
  readonly onProfileDeleted: () => unknown,
  readonly onProfileDeleteCanceled: () => unknown
};
...
export function ProfileDeleteSuccess(_props: Record<any, any>) {
  return (
