...
type ZipFileRowProps = ConnectedProps<ZipFileRowOwnProps, Record<any, any>, ZipFileRowDispatchProps>;
...
const ZipFileRow = explicitConnect<ZipFileRowOwnProps, Record<any, any>, ZipFileRowDispatchProps>({
...
class ZipFileViewerImpl extends React.PureComponent<Props> {
  ...
  _takeTreeViewRef = (treeView: null | TreeView<ZipDisplayData>) => (this._treeView = treeView);
...
export const ZipFileViewer = explicitConnect<Record<any, any>, StateProps, DispatchProps>({
