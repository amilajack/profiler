...
const PHASE_OPACITIES = PROPERTIES_IN_ORDER.reduce<Record<string, any>>((result, property, i, { length }) => {
...
type NetworkChartRowProps = {
  ...
  readonly select: (arg1: MarkerIndex) => unknown,
  readonly onLeftClick?: (arg1: MarkerIndex) => unknown,
  readonly onRightClick?: (arg1: MarkerIndex) => unknown,
  readonly onHover?: (arg1: MarkerIndex | null) => unknown,
...
export class NetworkChartRow extends React.PureComponent<NetworkChartRowProps, State> {
  state = {
    pageX: 0,
    pageY: 0,
    hovered: false,
