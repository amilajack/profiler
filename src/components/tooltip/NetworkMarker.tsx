...
export class TooltipNetworkMarkerPhases extends React.PureComponent<Props> {
  ...
  ): Array<React.ReactElement<React.ComponentProps<typeof NetworkPhase>>> | null {
 ...
 * the Network details.
 */
export function getNetworkMarkerDetails(payload: NetworkPayload): TooltipDetailComponent[] {
