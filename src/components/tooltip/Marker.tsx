...
function _maybeFormatDuration(start?: number, end?: number): string {
...
type StateProps = {
  ...
  readonly threadIdToNameMap: Map<number, string>,
  readonly markerSchemaByName: MarkerSchemaByName,
  readonly getMarkerLabel: (arg1: MarkerIndex) => string,
  readonly categories: CategoryList
};

type Props = ConnectedProps<OwnProps, StateProps, Record<any, any>>;
...
export const TooltipMarker = explicitConnect<OwnProps, StateProps, Record<any, any>>({
