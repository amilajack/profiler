...
type DetailProps = {
  ...
  readonly children?: undefined | null | boolean | string | number | React.ReactElement<any>
};
...
export type TooltipDetailComponent = React.ReactElement<React.ComponentProps<typeof TooltipDetail | typeof TooltipDetailSeparator>> | null;
type Props = {
  // This component accepts only TooltipDetail children.
  readonly children: Array<TooltipDetailComponent> | TooltipDetailComponent
};
