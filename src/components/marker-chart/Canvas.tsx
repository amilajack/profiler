...
class MarkerChartCanvasImpl extends React.PureComponent<Props> {
  ...
  drawCanvas = (
    ...
    const rightClickedRow: number | undefined =
  ...
  _getMarkerIndexToTimingRow = memoize(
    (markerTimingAndBuckets: MarkerTimingAndBuckets): Map<MarkerIndex, number> => {
...
export const MarkerChartCanvas = (withChartViewport as WithChartViewport<OwnProps, Props>)(MarkerChartCanvasImpl);
