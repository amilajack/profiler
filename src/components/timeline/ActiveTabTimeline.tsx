...
type Props = (SizeProps) & (ConnectedProps<Record<any, any>, StateProps, Record<any, any>>);
...
export const ActiveTabTimeline = explicitConnect<Record<any, any>, StateProps, Record<any, any>>({
