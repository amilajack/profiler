...
type StateProps = {
  ...
  readonly isCPUUtilizationProvided: boolean
};
...
type DispatchProps = {
  ...
  readonly changeTimelineTrackOrganization: typeof changeTimelineTrackOrganization
};

type Props = (SizeProps) & (ConnectedProps<Record<any, any>, StateProps, DispatchProps>);
...
export const FullTimeline = explicitConnect<Record<any, any>, StateProps, DispatchProps>({
