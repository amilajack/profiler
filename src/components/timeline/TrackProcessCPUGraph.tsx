...
type CanvasProps = {
  ...
  readonly maxCounterSampleCounts: number[],
...
type DispatchProps = Record<any, any>;
...
export const TrackProcessCPUGraph = explicitConnect<OwnProps, StateProps, DispatchProps>({
