...
type TimelineTrackContextMenuProps = ConnectedProps<Record<any, any>, StateProps, DispatchProps>;

type TimelineTrackContextMenuState = {
  searchFilter: string
};

class TimelineTrackContextMenuImpl extends PureComponent<TimelineTrackContextMenuProps, TimelineTrackContextMenuState> {
  state = { searchFilter: '' };
  _trackSearchFieldElem: {
    current: TrackSearchField | null
  } = React.createRef();
  ...
  renderLocalTracks(
    ...
    const localTrackMenuItems: Array<React.ReactElement<any> | any> = [];
...
export const TimelineTrackContextMenu = explicitConnect<Record<any, any>, StateProps, DispatchProps>({
