...
type OwnProps = {
  ...
  readonly style?: MixedObject /* This is used by Reorderable */,
...
const EMPTY_TRACK_ORDER: Array<TrackIndex> = [];
const EMPTY_LOCAL_TRACKS: Array<LocalTrack> = [];

export const TimelineGlobalTrack = explicitConnect<OwnProps, StateProps, DispatchProps>({
