...
type OwnProps = {
  ...
  readonly setInitialSelected: (el: InitialSelectedTrackReference, forceScroll?: boolean) => void
};

type StateProps = {
  readonly globalTrack: ActiveTabGlobalTrack,
  readonly isSelected: boolean,
  readonly resourceTracks: ActiveTabResourceTrack[]
};

type DispatchProps = {
  readonly selectActiveTabTrack: typeof selectActiveTabTrack
};
...
const EMPTY_RESOURCE_TRACKS: Array<ActiveTabResourceTrack> = [];

export const TimelineActiveTabGlobalTrack = explicitConnect<OwnProps, StateProps, DispatchProps>({
