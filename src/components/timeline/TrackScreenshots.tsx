...
const EMPTY_SCREENSHOTS_TRACK: Array<Marker> = [];

export const TimelineTrackScreenshots = explicitConnect<OwnProps, StateProps, DispatchProps>({
...
class ScreenshotStrip extends PureComponent<ScreenshotStripProps> {
  render() {
    ...
    const images: Array<React.ReactElement<React.ComponentProps<'div'>> | any> = [];
    const rangeLength = rangeEnd - rangeStart;
    const imageContainerWidth = trackHeight * 0.75;
    const timeToPixel = (time: Milliseconds | number) =>
