...
type DispatchProps = {
  readonly toggleResourcesPanel: typeof toggleResourcesPanel
};
...
export const TimelineActiveTabResourcesPanel = explicitConnect<OwnProps, StateProps, DispatchProps>({
