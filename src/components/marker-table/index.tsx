...
class MarkerTree {
  _getMarker: (arg1: MarkerIndex) => Marker;
  ...
  _getMarkerLabel: (arg1: MarkerIndex) => string;
  ...
  constructor(
    ...
    getMarkerLabel: (arg1: MarkerIndex) => string
  ) {
...
function _formatStart(start: number, zeroAt: Milliseconds) {
  return formatSeconds(start - zeroAt);
}

type StateProps = {
  readonly threadsKey: ThreadsKey,
  readonly getMarker: (arg1: MarkerIndex) => Marker,
  ...
  readonly getMarkerLabel: (arg1: MarkerIndex) => string
};
...
class MarkerTableImpl extends PureComponent<Props> {
  ...
  _takeTreeViewRef = (treeView: null | TreeView<MarkerDisplayData>) => (this._treeView = treeView);
...
export const MarkerTable = explicitConnect<Record<any, any>, StateProps, DispatchProps>({
