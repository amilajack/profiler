...
type DispatchProps = {
  ...
  readonly openSourceView: typeof openSourceView
};
...
class FlameGraphImpl extends React.PureComponent<Props> {
   ...
   */
  _nextSelectableInRow = (startingCallNodeIndex: IndexIntoCallNodeTable, direction: 1 | -1): IndexIntoCallNodeTable | undefined => {
    const {
      flameGraphTiming,
      callNodeInfo: { callNodeTable },
    } = this.props;
