...
type CategoryBreakdownState = {
  readonly openCategories: Set<string>
};

class CategoryBreakdown extends React.PureComponent<CategoryBreakdownProps, CategoryBreakdownState> {
  state = {
    openCategories: new Set(),
  };

  _toggleCategory = (event: React.ChangeEvent<HTMLInputElement>) => {
...
export const CallTreeSidebar = explicitConnect<Record<any, any>, StateProps, Record<any, any>>({
