...
export const withChartViewport: WithChartViewport<any, any> =
  ...
  <ChartOwnProps extends unknown>(ChartComponent: React.ComponentType<any>): any => {
    ...
    class ChartViewport extends React.PureComponent<ViewportProps, State> {
      ...
      _takeContainerRef = (container: null | HTMLDivElement) => {
      ...
      _addBatchedPreviewSelectionUpdate(
        callback: (arg1: HorizontalViewport) => PreviewSelection
      ) {
...
function clamp(min: UnitIntervalOfProfileRange | number, max: number, value: number) {
