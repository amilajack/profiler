...
type StateProps = {
  ...
  readonly getMarkerLabelToCopy: (arg1: MarkerIndex) => string,
...
class MarkerContextMenuImpl extends PureComponent<Props> {
  ...
  _hidingTimeout: number | null = null;
...
export const MaybeMarkerContextMenu = explicitConnect<Record<any, any>, MaybeProps, Record<any, any>>({
