...
type CanvasProps = {
  ...
  readonly treeOrderSampleComparator: (arg1: IndexIntoSamplesTable, arg2: IndexIntoSamplesTable) => number,
  readonly categories: CategoryList,
  readonly passFillsQuerier: (arg1: ActivityFillGraphQuerier) => void,
  readonly onClick: (arg1: React.MouseEvent<HTMLCanvasElement>) => void,
 ...
 */
function _findNextDifferentIndex(arr1: Float32Array, arr2: Float32Array, startIndex: number) {
