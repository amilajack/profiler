...
import {mergeProfilesForDiffing, mergeThreads} from '../../profile-logic/merge-compare';
...
describe('mergeProfilesForDiffing function', function () {
  it('merges the various tables properly in the diffing profile', function () {
    ...
    const libsForA: Array<any> = [];
    const resourcesForA: Array<any> = [];
  ...
  it('should set the resulting profile to symbolicated if all are symbolicated', () => {
    ...
    function getMergedProfilesSymbolication(profile1: any, profile2: any) {
...
describe('mergeThreads function', function () {
  ...
  it('merges the marker tables properly', function () {
    ...
    const markerNames: Array<any> = [];
    const markerStartTimes: Array<any> = [];
    const markerEndTimes: Array<any> = [];
    for (
      let markerIndex = 0;
  ...
  it('merges markers with stacks properly', function () {
    ...
    const markerStacksAfterMerge = mergedMarkers.data.map((markerData: any) =>
  ...
  it('merges CompositorScreenshot marker urls properly', function () {
    ...
    const markerUrlsAfterMerge = mergedMarkers.data.map((markerData: any) =>
