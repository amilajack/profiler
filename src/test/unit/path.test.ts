...
describe('PathSet', function () {
  ...
  it('implements the constructor', function () {
    ...
    sampleValues.forEach((value: any) => expect(set.has(value)).toBe(true));
  ...
  it('implements .forEach', function () {
    ...
    set.forEach(function (value1: any, value2: any, thisSet: any) {
  ...
  it('implements iterable, .values, .entries', function () {
    ...
    const expectedEntries = sampleValues.map((val: any) => [val, val]);
