...
describe('MarkerTable', function () {
  ...
  function setup(profile = getMarkerTableProfile()) {
    ...
    const getRowElement = (functionName: any) =>
      ensureExists(
  ...
  it('displays a context menu when right clicking', () => {
    ...
    function checkMenuIsDisplayedForNode(str: any) {
  ...
  describe('IPC marker context menu item', () => {
    ...
    const domWorkerTrackReference = { type: 'local', trackIndex: 0, pid: 222 } as const;
    const styleTrackReference = { type: 'local', trackIndex: 1, pid: 222 } as const;
