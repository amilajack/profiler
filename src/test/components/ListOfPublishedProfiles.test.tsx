...
async function storeProfileInformations(listOfProfileInformations: any) {
...
describe('ListOfPublishedProfiles', () => {
  function setup(props: any) {
    ...
    function getDeleteButtonForProfile(profileName: string): HTMLInputElement | HTMLButtonElement {
  ...
  describe('profile deletion', () => {
    function mockFetchForDeleteProfile({
      ...
      window.fetch
        .catch(404) // Catchall
        .mock(endpointUrl, (urlString: any, options: any) => {
  ...
  describe('renaming profiles', () => {
    async function setup(initialName: string) {
      ...
      async function findLinkByText(strOrRegexp: any): Promise<HTMLLinkElement> {
    ...
    function profileNameFromLinkElement(profileLink: HTMLLinkElement): string | null {
