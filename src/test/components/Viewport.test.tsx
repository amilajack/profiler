...
describe('Viewport', function () {
  ...
  function testScrollingHint(eventOptions: any) {
...
function setup(profileOverrides: MixedObject = {}) {
  ...
  function scroll(eventOverrides: any) {
  ...
  function scrollAndGetViewport(eventOverrides: any) {
    scroll(eventOverrides);
    return getChartViewport();
  }

  function clickAndDrag(fromX: any, fromY: any, toX: any, toY: any) {
    const from = { clientX: fromX, clientY: fromY } as const;
    const to = { clientX: toX, clientY: toY } as const;
