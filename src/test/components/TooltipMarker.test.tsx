...
describe('TooltipMarker', function () {
  it('renders tooltips for various markers', () => {
    ...
    markerIndexes.forEach((markerIndex: any) => {
  ...
  // processing pipeline.
  function setupWithPayload(markers: any) {
  ...
  describe('renders properly redirect network markers', () => {
    function redirectMarker(payloadOverrides?: Partial<NetworkPayload>) {
      return {
        id: 1234,
        startTime: 10.5,
        fetchStart: 111.0,
    ...
    ['Permanent', 'Internal', 'Temporary'].forEach((redirectType: any) => {
