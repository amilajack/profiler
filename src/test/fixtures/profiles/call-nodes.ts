...
import type {FuncTable, SamplesTable, FrameTable, Profile} from 'firefox-profiler/types';
...
export default function getProfile(): Profile {
  ...
  function addToStackTable(frame: number, prefix: null | number, category: number) {
