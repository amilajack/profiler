...
type JestMockFn<TArguments extends ReadonlyArray<any>, TReturn> = {
  ...
  */
 mockImplementation(fn: (...args: TArguments) => TReturn): jest.MockedFunction<any>,
 /**
  * Accepts a function that will be used as an implementation of the mock for
  * one call to the mocked function. Can be chained so that multiple function
  * calls produce different results.
  */
 mockImplementationOnce(fn: (...args: TArguments) => TReturn): jest.MockedFunction<any>,
 /**
  * Accepts a string to use in test result output in place of "jest.fn()" to
  * indicate which mock function is being referenced.
  */
 mockName(name: string): jest.MockedFunction<any>,
 /**
  ...
  */
 mockReturnValue(value: TReturn): jest.MockedFunction<any>,
 /**
  * Sugar for only returning a value once inside your mock
  */
 mockReturnValueOnce(value: TReturn): jest.MockedFunction<any>,
 /**
  * Sugar for jest.fn().mockImplementation(() => Promise.resolve(value))
  */
 mockResolvedValue(value: TReturn): jest.MockedFunction<any>,
 /**
  * Sugar for jest.fn().mockImplementationOnce(() => Promise.resolve(value))
  */
 mockResolvedValueOnce(value: TReturn): jest.MockedFunction<any>,
 /**
  * Sugar for jest.fn().mockImplementation(() => Promise.reject(value))
  */
 mockRejectedValue(value: TReturn): jest.MockedFunction<any>,
 /**
  * Sugar for jest.fn().mockImplementationOnce(() => Promise.reject(value))
  */
 mockRejectedValueOnce(value: TReturn): jest.MockedFunction<any>
};
...
type EnzymeMatchersType = {
 ...
 toHaveProp: ((propKey: string, propValue?: any) => void) & ((props: Record<any, any>) => void),
 toHaveRef(refName: string): void,
 toHaveState: ((stateKey: string, stateValue?: any) => void) & ((state: Record<any, any>) => void),
 toHaveStyle: ((styleKey: string, styleValue?: any) => void) & ((style: Record<any, any>) => void),
...
type JestExtendedMatchersType = {
  ...
  * @param {Mock} mock
  */
 toHaveBeenCalledBefore(mock: jest.MockedFunction<any>): void,
 /**
...
interface JestExpectType {
 not: JestExpectType & EnzymeMatchersType & DomTestingLibraryType & JestJQueryMatchersType & JestStyledComponentsMatchersType & JestExtendedMatchersType & SnapshotDiffType;
 /**
  ...
  * class.
  */
 toBeInstanceOf(cls: Flow.Class<any>): void;
 /**
  ...
  * Alias: .toThrowError
  */
 toThrow(message?: string | Error | Flow.Class<Error> | RegExp): void;
 toThrowError(message?: string | Error | Flow.Class<Error> | RegExp): void;
 /**
...
type JestObjectType = {
  ...
  * implementation.
  */
 fn<TArguments extends ReadonlyArray<any>, TReturn>(implementation?: (...args: TArguments) => TReturn): jest.MockedFunction<any>,
 /**
  ...
  */
 requireActual<T>(m: .Flow<T> | string): T,
 /**
  ...
  * object[methodName].
  */
 spyOn(object: any, methodName: string, accessType?: 'get' | 'set'): jest.MockedFunction<any>,
 /**
...
declare function afterEach: (
 fn: (done: JestDoneFn) => Promise<unknown> | null | undefined,
 timeout?: number,
) => void;
...
declare var describe: {
  ...
  */
 each(table: Array<Array<unknown> | unknown>): (
  name: JestTestName,
  fn?: (...args: Array<any>) => Promise<unknown> | null | undefined,
  timeout?: number,
 ) => void
};
...
type JestPrettyFormatIndent = (arg1: string) => string;
type JestPrettyFormatPrint = (arg1?: any) => string;
...
declare var expect: {
 ...
 (value?: any): JestExpectType & JestPromiseType & EnzymeMatchersType & DomTestingLibraryType & JestJQueryMatchersType & JestStyledComponentsMatchersType & JestExtendedMatchersType & SnapshotDiffType,
 /** Add additional Jasmine matchers to Jest's roster */
 extend(
  matchers: {
   [name: string]: JestMatcher
  },
 ): void,
 ...
 toBeOneOf(value: Array<unknown>): Array<unknown>,
 not: {
  arrayContaining: (value: ReadonlyArray<unknown>) => Array<unknown>,
  objectContaining: (value: Record<any, any>) => any,
  stringContaining: (value: string) => string,
  stringMatching: (value: string | RegExp) => string,
  toBeOneOf(value: Array<unknown>): Array<unknown>
 }
