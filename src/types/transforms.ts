...
type ExtractType = <T extends string, S extends {
 readonly type: T
}>(transform: S) => T;

export type TransformType = Flow.ObjMap<TransformDefinitions, ExtractType>[keyof Flow.ObjMap<TransformDefinitions, ExtractType>];
