...
export type GeckoMarkerTuple = [IndexIntoStringTable, Milliseconds | null, Milliseconds | null, MarkerPhase, IndexIntoCategoryList, MarkerPayload_Gecko];
...
export type GeckoSamples = {
  ...
  data: Array<[null | IndexIntoGeckoStackTable, // since profile.meta.startTime
  Milliseconds, // milliseconds since the last event was processed in this
  // thread's event loop at the time that the sample was taken
  Milliseconds] | [null | IndexIntoGeckoStackTable, // since profile.meta.startTime
  Milliseconds, // milliseconds since the last event was processed in this
  // thread's event loop at the time that the sample was taken
  Milliseconds, // CPU usage value of the current thread.
...
export type GeckoFrameTable = {
  ...
  null | MixedObject, // The line of code
