 ...
 * a Map-like structure.
 */
export function objectEntries<Key, Value>(object: Partial<Record<Key, Value>>): Array<[Key, Value]> {
...
export function getObjectValuesAsUnion<T extends any>(obj: T): Array<T[keyof T]> {
