...
type MapDispatchToProps<OwnProps extends any, DispatchProps extends any> = ((dispatch: Dispatch, ownProps: OwnProps) => DispatchProps) | DispatchProps;

type MergeProps<StateProps, DispatchProps extends any, OwnProps extends any, Props extends any> = (stateProps: StateProps, dispatchProps: DispatchProps, ownProps: OwnProps) => Props;
 ...
 */
export type WrapDispatchProps<DispatchProps extends any> = Flow.ObjMap<DispatchProps, WrapActionCreator<any> & WrapThunkActionCreator<any, any>>;
 ...
 */
export type WrapFunctionInDispatch<Fn extends any> = ReturnType<WrapActionCreator<any> & WrapThunkActionCreator<any, any>>;
...
export type ConnectedProps<OwnProps extends any, StateProps extends any, DispatchProps extends any> = Readonly<(OwnProps) & (StateProps) & (DispatchProps)>;

export type ConnectedComponent<OwnProps extends any, StateProps extends any, DispatchProps extends any> = React.ComponentType<ConnectedProps<OwnProps, StateProps, DispatchProps>> | React.FC<ConnectedProps<OwnProps, StateProps, DispatchProps>>;
