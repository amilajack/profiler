 ...
 */
export const getProfileViewOptions: Selector<ProfileViewState['viewOptions']> = (state) => getProfileView(state).viewOptions;
...
export const getPerceptualSpeedIndexProgress: Selector<ProgressGraphData[] | null> = (state) => getVisualMetrics(state).PerceptualSpeedIndexProgress ?? null;
export const getContentfulSpeedIndexProgress: Selector<ProgressGraphData[] | null> = (state) => getVisualMetrics(state).ContentfulSpeedIndexProgress ?? null;
export const getProfilerConfiguration: Selector<ProfilerConfiguration | null | undefined> = (
  state
...
const _counterSelectors: Record<string, any> = {};
...
function _createCounterSelectors(counterIndex: CounterIndex) {
  ...
  const getAccumulateCounterSamples: Selector<Array<AccumulatedCounterSamples>> = createSelector(getCommittedRangeFilteredCounter, (counters) =>
    accumulateCounterSamples(
 ...
 */
export const getGlobalTrackFromReference: DangerousSelectorWithArguments<GlobalTrack, GlobalTrackReference> = (state, trackReference) =>
 ...
 */
export const getLocalTracks: DangerousSelectorWithArguments<LocalTrack[], Pid> = (state, pid) =>
  ensureExists(
 ...
 */
export const getLocalTrackFromReference: DangerousSelectorWithArguments<LocalTrack, LocalTrackReference> = (state, trackReference) =>
...
export const getLocalTrackName = (state: State, pid: Pid, trackIndex: TrackIndex): string => ensureExists(
 ...
 * This returns all TrackReferences for global tracks.
 */
export const getActiveTabGlobalTrackReferences: Selector<GlobalTrackReference[]> = createSelector(getActiveTabGlobalTracks, (globalTracks) =>
  globalTracks.map((globalTrack, trackIndex) => ({
    type: 'global',
    trackIndex,
  }))
 ...
 * as this is a simple value look-up.
 */
export const getActiveTabGlobalTrackFromReference: DangerousSelectorWithArguments<ActiveTabGlobalTrack, ActiveTabGlobalTrackReference> = (state, trackReference) =>
 ...
 * as this is a simple value look-up.
 */
export const getActiveTabResourceTrackFromReference: DangerousSelectorWithArguments<ActiveTabResourceTrack, ActiveTabResourceTrackReference> = (state, trackReference) =>
 ...
 */
export const getInnerWindowIDToPageMap: Selector<Map<InnerWindowID, Page> | null> = createSelector(getPageList, (pages) => {
  if (!pages) {
...
export const getPagesMap: Selector<Map<TabID, Page[]> | null> = createSelector(
  ...
  (pageList, innerWindowIDToPageMap) => {
    ...
    const appendPageMap = (tabID: TabID, page: Page) => {
    ...
    for (const page of pageList) {
      if (page.embedderInnerWindowID === undefined) {
        ...
        const getTopMostParent = (item: Page) => {
 ...
 * of the components.
 */
const _emptyRelevantPagesForActiveTab: Array<Page> = [];
 ...
 */
export const getInnerWindowIDSetByTabID: Selector<Map<TabID, Set<InnerWindowID>> | null> = createSelector(getPagesMap, (pagesMap) => {
