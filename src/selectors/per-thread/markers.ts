...
export function getMarkerSelectorsPerThread(
  ...
  const _getThreadId: Selector<number | undefined> = (state) =>
  ...
  const getMarkerIndexToRawMarkerIndexes: Selector<IndexedArray<MarkerIndex, IndexIntoRawMarkerTable[]>> = createSelector(
    getDerivedMarkerInfo,
   ...
   */
  const getMarkerGetter: Selector<(arg1: MarkerIndex) => Marker> = createSelector(
    getFullMarkerList,
    (markerList) =>
  ...
  const filterMarkerIndexesCreator =
    ...
    (getMarker: (arg1: MarkerIndex) => Marker, markerIndexes: MarkerIndex[]): MarkerIndex[] => MarkerData.filterMarkerIndexes(getMarker, markerIndexes, filterFunc);
   ...
   */
  const getActiveTabFilteredMarkerIndexesWithoutGlobals: Selector<MarkerIndex[]> = createSelector(
    getMarkerGetter,
    getFullMarkerListIndexes,
   ...
   */
  const getMarkerTooltipLabelGetter: Selector<(arg1: MarkerIndex) => string> =
    createSelector(
      getMarkerGetter,
      ProfileSelectors.getMarkerSchema,
      ProfileSelectors.getMarkerSchemaByName,
   ...
   */
  const getMarkerTableLabelGetter: Selector<(arg1: MarkerIndex) => string> =
    createSelector(
      getMarkerGetter,
      ProfileSelectors.getMarkerSchema,
      ProfileSelectors.getMarkerSchemaByName,
   ...
   */
  const _getMarkerChartLabelGetter: Selector<(arg1: MarkerIndex) => string> =
    createSelector(
      getMarkerGetter,
      ProfileSelectors.getMarkerSchema,
      ProfileSelectors.getMarkerSchemaByName,
   ...
   * in the marker table.
   */
  const getMarkerLabelToCopyGetter: Selector<(arg1: MarkerIndex) => string> =
