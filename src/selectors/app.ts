...
export const getTrackThreadHeights: Selector<Partial<Record<ThreadsKey, CssPixels>>> = (state) => getApp(state).trackThreadHeights;
...
export const getCurrentProfileUploadedInformation: Selector<UploadedProfileInformation | null> = (state) => getApp(state).currentProfileUploadedInformation;
