...
const REMOVE_URLS_REGEXP = (function () {
  const protocols = ["http", "https", "ftp", "file", "moz-extension", "moz-page-thumb"];
  return new RegExp(
 ...
 */
export function removeURLs(string: string, redactedText: string = "<URL>"): string {
 ...
 */
export function removeFilePath(filePath: string, redactedText: string = "<PATH>"): string {
