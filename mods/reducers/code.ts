...
import type { Reducer, SourceCodeStatus, AssemblyCodeStatus, CodeState } from "~/components/FFP/types";
import { combineReducers } from "redux";

const sourceCodeCache: Reducer<Map<string, SourceCodeStatus>> = (state = new Map(), action) => {
  switch (action.type) {
...
const assemblyCodeCache: Reducer<Map<string, AssemblyCodeStatus>> = (state = new Map(), action) => {
  switch (action.type) {
