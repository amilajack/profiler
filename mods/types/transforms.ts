...
import type { IndexIntoFuncTable, IndexIntoResourceTable, IndexIntoCategoryList } from "./profile";
import type { CallNodePath, ThreadsKey } from "~/components/FFP/types/profile-derived";
import type { ImplementationFilter } from "~/components/FFP/types/actions";
...
export type TransformDefinitions = {
   ...
   */
  ["collapse-indirect-recursion"]: {
    readonly type: "collapse-indirect-recursion";
    readonly funcIndex: IndexIntoFuncTable;
    readonly implementation: ImplementationFilter;
  };
  /**
...
export type TransformType = Flow.ObjMap<TransformDefinitions, ExtractType>[keyof Flow.ObjMap<
  TransformDefinitions,
  ExtractType
>];

export type TransformStack = Transform[];
export type TransformStacksPerThread = Partial<Record<ThreadsKey, TransformStack>>;
