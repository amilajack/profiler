...
type HasComponentProps<T, D extends unknown = DefaultProps<T>> = T extends (prop: infer P) => React.ReactElement
...
export declare namespace Flow {
  ...
  type ObjMap<O extends Record<string, any>, F extends (...args: any[]) => any> = { [P in keyof O]: ReturnType<F> };
}
