...
import type { MarkerPayload_Gecko, MarkerSchema } from "~/components/FFP/types/markers";
import type { Milliseconds, Nanoseconds, MemoryOffset, Bytes } from "~/components/FFP/types/units";
...
export type GeckoSamples = {
  ...
  data: Array<
    | [
        null | IndexIntoGeckoStackTable, // since profile.meta.startTime
...
export type GeckoFrameTable = {
  ...
  data: Array<
    [
      ...
      null | IndexIntoStringTable, // The line of code
