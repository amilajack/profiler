...
import type { FuncToFuncsMap } from "~/components/FFP/profile-logic/symbolication";
import type {
  ApiQueryError,
  DecodedInstruction,
  PseudoStrategy,
  ...
  UploadState,
  UrlState,
} from "~/components/FFP/types/state";
import type { TransformStacksPerThread } from "~/components/FFP/types/transforms";
import type { CssPixels, Milliseconds, StartEndRange } from "~/components/FFP/types/units";
import type { FatalError, TemporaryError } from "~/components/FFP/utils/errors";
import type { IndexIntoCategoryList, IndexIntoLibs, Pid, Profile, TabID, Thread, ThreadIndex } from "./profile";
import type {
  ActiveTabTimeline,
  CallNodePath,
  CallNodeTable,
...
type ReceiveProfileAction =
  ...
  | {
      readonly type: "RETRY_PROFILE_QUERY";
    }
  | {
...
type UrlStateAction =
  ...
  | {
      readonly type: "CHANGE_SELECTED_BOTTOM_BOX_TAB";
...
type ExpandedModeAction = {
  readonly type: "TOGGLE_EXPANDED_MODE";
