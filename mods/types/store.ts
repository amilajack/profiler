...
import type { Action as ActionsRef } from "~/components/FFP/types/actions";
import type { State as StateRef } from "~/components/FFP/types/state";
 ...
 */
export type Selector<T> = (arg1: State) => T;
 ...
 */
export type DangerousSelectorWithArguments<T, A1, A2 = undefined, A3 = undefined> = (
  arg1: State,
  arg2: A1,
  arg3?: A2,
  arg4?: A3
 ...
 * A thunk action
 */
export type ThunkAction<Returns> = (dispatch: Dispatch, arg2: GetState) => Returns;
...
export type Store = EnhancedStore<State, Action> & { dispatch: Dispatch };
